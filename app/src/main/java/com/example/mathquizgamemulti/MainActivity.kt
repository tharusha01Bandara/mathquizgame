package com.example.mathquizgamemulti
...
class MainActivity : AppCompatActivity() {
    ...
    // Define constants for the different operations
    companion object {
    ...
    private val incorrect: Int by lazy { ContextCompat.getColor(this, R.color.incorrect) }
    ...
    // Start the game with the selected operation
    ...
    private fun generateRandomQuestion(operation: Int): Question {
        ...
        // Generate the question and correct answer based on the selected operation
    ...
    // Generate a list of options with the correct answer and three random wrong answers
    ...
    private fun endGame() {
        ...
        // Display the final score and highest score
        finalscoretv.text = "Your Score $score\nHighScore $highestScore"
    ...
    fun onOptionSelected(view: View) {
        ...
        if (selectedOption == currentQuestion.correctOption) {
            ...
            view.setBackgroundColor(incorrect)
